...
if __name__ == "__main__":
    parser = Parser()
    print(parser.similarity('Напиток Добрый Кола, Кола зеро 1 л', 'Игрушка мягкая Мишка, 15 см, 1 шт.'))
    parser.parse_stores()
    s = ['Чай \"Гринфилд\" Кениан Санрайз черн. с/я 100пак х 2г', 'Колбаса САЛЬЧИЧОН ЧМПЗ с/к, нарезка, 100Г/120Г', 'Колбаса САЛЬЧИЧОН РУБЛЕВСКИЙ с/к, в/у, 350 г', 'Зубная паста КОЛГЕЙТ МАКС блеск, со фтором/ блеск с кристаллами, 100 мл', 'Вино игристое ДИДИКАТО белое сухое/белое полусладкое, 0,75 л', 'Стиральный порошок АРИЭЛЬ Колор, автомат /2,5 кг/ Масло ши /2,5 кг/ Ленор, 2,5 кг']
    for i in s:
        print(parser.get_weight(i))